...
public class BumpReportService implements ReportInterface {
    ...
    public ReportDto create(ReportRequest request) {
        ...
        BumpReport report = BumpReport.builder()
                .expiredAt(null)
                .user(user)
                .likeCount(0)
                .isAccept(true)
    ...
    public ReportDto like(Long id) {
        return reportService.like(ReportType.BUMP, id, null);
    }

    @Override
    public ReportDto disLike(Long id) {
        return reportService.disLike(ReportType.BUMP, id, null);
    }
    ...
    public List<Integer> findTopHours(Integer limit) {
        return reportService.findTopHours(limit, ReportType.BUMP);
    }
}
